...
function CheckBoxPreference({ title, value, summaryOff, summaryOn, onNotificationPreferenceChage, prefKey }){
...
const mapDispatchToProps = dispatch => {
    return {
        onNotificationPreferenceChage: (key, fieldToUpdate, value) => dispatch(handleSavePerference({ key, fieldToUpdate, value }))
    }
}
